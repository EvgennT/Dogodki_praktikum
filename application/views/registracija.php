...
<article>
  <header>
	...
	<div id="container" class="row">
		...
		<center>
		<form class="col-3 rcorners1" class="" id="formRegistracija" method="post" role="form" action="<?php echo $this->config->base_url(); ?>CtrMain/registracija_perform">
